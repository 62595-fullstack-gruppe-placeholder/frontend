  ...
  return (
    <div className="flex flex-col items-center gap-8 w-full">
      ...
      <div
        ...
        ${isScanning ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-10 max-h-0 overflow-hidden"}
      `}
      >
      ...
      <div className="w-full max-w-4xl px-4 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="box !bg-background/40 backdrop-blur-md border border-secondary/10 overflow-hidden shadow-xl p-8 min-h-[300px] transition-all hover:border-white/20">
            ...
            <p className="p text-left leading-relaxed border-t border-secondary/10 pt-4 text-secondary">
              Have you ever lost 1000's of dollars because a junior developer pushed an API key? Our goal is to prevent scenarios like this with automated security overviews and weekly reviews.
            </p>
          </div>

          <div className="box !bg-background/40 backdrop-blur-md border border-secondary/10 overflow-hidden shadow-xl p-8 min-h-[300px] transition-all hover:border-white/20">
            <div className="flex items-center gap-4 mb-6">
              <h2 className="text-3xl font-black text-text-main">How?</h2>
            </div>

            <p className="p text-left leading-relaxed border-t border-secondary/10 pt-4 text-secondary">
              Using proprietary indexing technology, Repo Racoon sniffs through your repository history to identify vulnerabilities like hardcoded API keys, database credentials, or hidden secrets.
            </p>
          </div>
        </div>
      </div>
